...
#include <memory>
#include "../../TensileTest/settings.h"
...
QT_MOC_LITERAL(3, 15, 18) // "on_MWindow_clicked"

    },
    "Settings\0Open\0\0on_MWindow_clicked"
};
...
void Settings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_MWindow_clicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Settings::Open)) {
                *result = 0;
                return;
            }
        }
