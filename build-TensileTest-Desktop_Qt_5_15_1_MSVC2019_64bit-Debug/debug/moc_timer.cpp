...
QT_MOC_LITERAL(3, 16, 7), // "process"
QT_MOC_LITERAL(4, 24, 5), // "start"
QT_MOC_LITERAL(5, 30, 6) // "signal"

    },
    "Timer\0finished\0\0process\0start\0signal"
};
...
void Timer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Timer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Timer::process)) {
                *result = 1;
                return;
            }
        }
